...
class TestGetPipPath:
    def test_get_pip_path_1(
        self, execute_command_mock: Mock, get_destination_command_mock: Mock
    ):
        ...
        execute_command_mock.assert_has_calls(
            [call(["which-where", "pip"]), call(["pip", "--version"])]
        )
    ...
    def test_get_pip_path_2(
        ...
        get_destination_command_mock.assert_called()
        execute_command_mock.assert_has_calls(
            [call(["which-where", "pip3"]), call(["pip3", "--version"])]
        )
...
class TestGetPythonPath:
    def test_get_python_path_1(
        ...
        execute_command_mock.assert_has_calls([call(["which-where", "python"])])
    ...
    def test_get_python_path_3(
        ...
        assert python_path == "/home/user/requirements-txt/venv/bin/python"
        execute_command_mock.assert_has_calls([call(["which-where", "python3"])])
    ...
    def test_get_python_path_4(
        ...
        assert python_path == "/home/user/requirements-txt/venv/bin/python"
        execute_command_mock.assert_has_calls(
            [call(["which-where", "python3"]), call(["which-where", "python"])]
        )
